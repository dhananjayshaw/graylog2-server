...
class GuavaCacheDocumentation extends React.Component {
  render() {
    return (<div>
      ...
      <p>Please make sure your DNS AM-Trap servers have enough heap to accomodate the cached entries and monitor the cache efficiency.</p>

      <Alert style={{ marginBottom: 10 }} bsStyle="info">
        <h4 style={{ marginBottom: 10 }}>Implementation details</h4>
        <p>The cache is local to each DNS AM-Trap server, they do not share the entries.</p>
